...
public class LoginAsHrofficerRepo {
	...
	public  LoginAsHrofficerRepo(WebDriver driver) {
		this.driver = driver;
	...
	public void sendHRemail(String hrofficerusername) {
		hremail.sendKeys(hrofficerusername);
	...
	public void sendHRpassword(String hrofficerpassword) {
		hrpassword.sendKeys(hrofficerpassword);
	...
	public void selectThePosition(String position) {
		...
		select.selectByValue("HR Officer");
	}
