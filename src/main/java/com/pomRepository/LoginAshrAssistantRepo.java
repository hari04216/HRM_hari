...
public class LoginAshrAssistantRepo {
	...
	public LoginAshrAssistantRepo(WebDriver driver) {
		this.driver = driver;
	...
	public void sendHRemail(String hrAssistusername) {
		hremail.sendKeys(hrAssistusername);
	...
	public void sendHRpassword(String hrAssistpassword) {
		hrpassword.sendKeys(hrAssistpassword);
	...
	public void selectThePosition(String position) {
		...
		select.selectByValue("HR Assistant");
	}
